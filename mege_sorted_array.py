# 88. You are given two integer arrays nums1 and nums2, sorted in non-decreasing order, and two
...
# array nums1. To accommodate this, nums1 has a length of m + n, where the first m element
